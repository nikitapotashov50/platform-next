...
import ContentList from '../client/components/Content/ContentList'
import { loadPosts, loadMore } from '../client/redux/posts'
import Panel from '../client/components/Panel'
import PanelMenu from '../client/components/PanelMenu'

const menuItems = [
  { href: '/content', path: '/content', title: 'Все', code: 'index' },
  { href: '/content/video', path: '/content/video', title: 'Видео', code: 'video' },
  { href: '/content/presentations', path: '/content/presentations', title: 'Презентации', code: 'presentations' },
  { href: '/content/free', path: '/content/free', title: 'Бесплатно', code: 'free' }
]
  ...
  render () {
    ...
    return (
      <FeedLayout>
        ...
        { (this.props.posts.length > 0) && <ContentList posts={this.props.posts} pathname={this.props.url.pathname} />}
...
export default Page(ContentPage, {
  title: 'Отчеты',
