...
const AuthLogin = ({ recoverySwitch, message, values, onInput, errors, submit, fetching, t }) => (
  <div className='login-form'>
    ...
    <Loader loading={fetching}>
      <form method='post'>
        ...
        <div className='login-form__row login-form__row_double-margin login-form__row_centered'>
